    ...
    <div class="mt-8">
      ...
      <form action="{{ route('contact') }}" method="POST">
        ...
        <div class="mb-4">
          ...
          <textarea id="body" class="w-full h-24 p-4 text-xs leading-none resize-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="ご自由にご記入ください" name="body"> value="{{ old('body') }}</textarea>
        </div>
        @if ($errors->has('body'))
